...
from FRA import sim_consist, FRASim, code2Vector, lettercode2Strategy
print("Done!")
...
regions_codes = ['abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789;:',\
				 '',\
				 'GHIJKLMNOPQRSTUVWXYZ0123456789;:',\
				 'abcdefghijklmnopqrstuvwxyzABCDEF',\
                 'abcdijklqrstyzABGHIJOPQRWXYZ4567',\
                 'efghmnopuvwxCDEFKLMNSTUV012389;:',\
                 'jklmnorstuvwzABCDEHIJKLMPQRSTUXYZ012',\
                 'abcdefghipqxyFGNOVW3456789;:'
				]
regions = [code2Vector(lettercode2Strategy(r,8),8) for r in regions_codes]
...
def dibuja_FRAS(r1, r2, j, threshold):
    ...
    plt.show()
    # fig.savefig('myimage.png', format='eps', dpi=1200)
    fig.savefig('ronda.png', dpi=600)
